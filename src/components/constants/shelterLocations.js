...
{
    id: 9,
    name: "עמותת הרצליה ונתניה אוהבות חיות - סניף הרצליה",
    address: "הרב עובדיה יוסף 36, הרצליה",
    website: "https://herzelialovesanimals.org/",
    nav: "32.15334872562616, 34.818601149800536",
    position: {
        lat: 32.15334872562616,
        lng: 34.818601149800536
    }
},
{
    id: 10,
    name: "עמותת S.O.S חיות",
    address: "המעפילים, כפר שמריהו",
    website: "http://www.sospets.co.il/",
    nav: "32.17918040116079, 34.82691781303298",
    position: {
        lat: 32.17918040116079,
        lng: 34.82691781303298
    }
}
]